    ...
    pluginList !== null && (
      <>
        ...
        >
          ...
          <TableBody emptyContent={'No History to display.'} items={items}>
            {(item) =>
        ...
        <div className="mt-[8px] flex justify-around">
          <Pagination
            ...
            onChange={setPage}
          />
          <Button size="sm" className="my-auto" onPress={clearData}>
            {t('common.clear')}
          </Button>
        </div>
                            ...
                            <Button
                              ...
                              onPress={async () => {
                                if (getServiceSouceType(instanceKey) === ServiceSourceType.PLUGIN) {
                                  ...
                                  builtinCollectionServices[getServiceName(instanceKey)]
                              ...
                              <img
                                src={
                                  getServiceSouceType(instanceKey) === ServiceSourceType.PLUGIN
                                    ...
                                    : builtinCollectionServices[getServiceName(instanceKey)].info
                                        .icon
                                }
