...
function getLabels(): typeof fallbackLabels {
    ...
    return {
        ...
        selectionTranslate:
            getNestedValue(resource, ['config', 'hotkey', 'selection_translate']) ?? fallbackLabels.selectionTranslate,
        inputTranslate: getNestedValue(resource, ['config', 'hotkey', 'input_translate']) ?? fallbackLabels.inputTranslate,
        ocrRecognize: getNestedValue(resource, ['config', 'hotkey', 'ocr_recognize']) ?? fallbackLabels.ocrRecognize,
        ocrTranslate: getNestedValue(resource, ['config', 'hotkey', 'ocr_translate']) ?? fallbackLabels.ocrTranslate,
