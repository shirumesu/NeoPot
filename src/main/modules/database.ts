...
export function runMigrations(): void {
    try {
        ...
        const message = error instanceof Error && error.message.includes('Could not locate the bindings file')
...
export async function importLegacyHistory(sourcePath: string): Promise<{ status: 'imported' | 'rollback' }> {
